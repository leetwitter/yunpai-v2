...
#: M4 施工后为空：``import_m4_purchase_suggestions_json`` 已由旧 echo 假实现替换为
#: ``m4_purchase_local.import_m4_purchase_suggestions_json`` 真实实现（落库 + 幂等 409 +
#: tenant 归属），按 rows-S5.md:67 回归 BOUND_LOCAL（P0）。
